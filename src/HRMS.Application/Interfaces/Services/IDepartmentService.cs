...
namespace HRMS.Application.Interfaces.Services
{
    ...
    {
        Task<Result<DepartmentDto>> GetByNameAsync(string name, CancellationToken token = default);
        Task<Result<DepartmentDto>> GetByIdAsync(int id, CancellationToken token = default);
        //Task<IEnumerable<DepartmentDto>> GetAllAsync(CancellationToken token = default);
        
        //Task<DepartmentDto> CreateAsync(CreateDepartmentDto dto, CancellationToken token = default);
